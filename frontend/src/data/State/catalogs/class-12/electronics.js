/**
 * Generated Catalog: Class XII - Electronics
 */
export const ELECTRONICS_CLASS_12 = {
  classId: 'class-12',
      ...
      topics: [
        {
          ...
          animationType: 'electronicsIntro',
          learningObjectives: [
          ...
          questions: [
            {
              id: 'ch1-t1-q1',
              text: 'Explain the fundamental importance of Electronics in everyday life.',
          ...
          misconceptions: [
            {
              id: 'ch1-t1-m1',
              probe: 'Do you think Electronics is only theoretical and has no real-world use?',
              options: ['Yes, it is mostly abstract', 'No, it applies directly to reality'],
              correctIndex: 1,
              correction: 'Electronics provides the foundational rules governing real-world interactions.',
