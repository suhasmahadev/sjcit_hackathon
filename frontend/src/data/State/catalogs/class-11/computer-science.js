/**
 * Generated Catalog: Class XI - Computer Science
 */
export const COMPUTER_SCIENCE_CLASS_11 = {
  classId: 'class-11',
  classLabel: 'Class XI',
      ...
      topics: [
        {
          ...
          animationType: 'computer-scienceIntro',
          learningObjectives: [
          ...
          questions: [
            {
              id: 'ch1-t1-q1',
              text: 'Explain the fundamental importance of Computer Science in everyday life.',
          ...
          misconceptions: [
            {
              id: 'ch1-t1-m1',
              probe: 'Do you think Computer Science is only theoretical and has no real-world use?',
              options: ['Yes, it is mostly abstract', 'No, it applies directly to reality'],
              correctIndex: 1,
              correction: 'Computer Science provides the foundational rules governing real-world interactions.',
