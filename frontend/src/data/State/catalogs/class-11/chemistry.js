/**
 * Generated Catalog: Class XI - Chemistry
 */
export const CHEMISTRY_CLASS_11 = {
  classId: 'class-11',
  classLabel: 'Class XI',
  subject: 'Chemistry',
  board: 'State Board',
      ...
      topics: [
        {
          ...
          questions: [
            {
              id: 'ch1-t1-q1',
              text: 'Explain the fundamental importance of Chemistry in everyday life.',
          ...
          misconceptions: [
            {
              id: 'ch1-t1-m1',
              probe: 'Do you think Chemistry is only theoretical and has no real-world use?',
              options: ['Yes, it is mostly abstract', 'No, it applies directly to reality'],
              correctIndex: 1,
              correction: 'Chemistry provides the foundational rules governing real-world interactions.',
